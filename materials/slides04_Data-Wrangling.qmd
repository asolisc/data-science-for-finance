...
mutate(data, condition) allows you to create new variables (columns)
based on existing columns or not based on your data:
...
mutate(data, condition) allows you to create new variables (columns)
based on existing columns. You can even use newly created columns in the same step.
